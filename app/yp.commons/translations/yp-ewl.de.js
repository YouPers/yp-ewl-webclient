...
angular.module('yp-ewl').
    config(['$translateProvider', function ($translateProvider) {
        ...
        $translateProvider.translations('de', {
            ...
            generalStresslevel: 'Allgemeiner Stresslevel',
            ...
            atWork: 'Stress am Arbeitsplatz',
            leisureTime: 'Stress in der Freizeit (Jobexterne Stressfaktoren)',
            stressType: 'Stresstyp (Stressverstärker)',
            stressMeasures: 'Stressbewältigung (Entspannung/Ausgleich)',
            WORK: 'Arbeitsplatz',
            LEISURE: 'Freizeit',
            TIME: 'Zeit',
            NUTRITION: 'Ernährung',
