(function () {
    ...
    angular.module('yp.cockpit')
        ...
        .factory('ActivityChart2Service', ['Restangular', function(Restangular) {
    ...
    //            var cols = data.cols;
        ...
        .controller('ActivityChart2Controller', ['$scope', 'ActivityChart2Service', function ($scope, ActivityChartService) {
