(function () {
    ...
    angular.module('yp.components.multipleViewCarousel', [])
        .directive('multipleViewCarousel', ['$location', '$state', function ($location, $state) {
            return {
                ...
                templateUrl: 'components/directives/multiple-view-carousel-directive/multiple-view-carousel-directive.html',
